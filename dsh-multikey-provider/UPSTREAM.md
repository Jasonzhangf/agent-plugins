...
imported. The two official packages are pinned in `dependencies` because the
replacement package composes their public entrypoints at runtime, and they also
remain installed by the profile for reversible composition.
