...
export const en = {
  ...
  poolTitle: 'Additional API keys',
  poolMode: 'Selection mode',
  poolPriority: 'Priority',
  poolWeighted: 'Weighted',
  poolMaxAttempts: 'Maximum attempts',
  poolFailureThreshold: 'Failure threshold',
  poolOpenCircuitMs: 'Open circuit (ms)',
  poolSavePolicy: 'Save key policy',
  poolPrimaryEnabled: 'Use primary key',
  poolEnabled: 'Enabled',
  poolProbe: 'Probe key',
  poolRemove: 'Delete key',
  poolKeyId: 'Key ID',
  poolCredentialRef: 'Credential reference',
  poolApiKey: 'API key',
  poolPriorityField: 'Priority',
  poolWeight: 'Weight',
  poolAddKey: 'Add key',
  poolKeyIdInvalid: 'Use a lowercase ID starting with a letter.',
  poolCredentialRefInvalid: 'Use a valid environment-style credential reference.',
  poolKeyRequired: 'Enter the additional API key.',
  poolKeyIdDuplicate: 'Key ID already exists.',
  poolCredentialRefDuplicate: 'Credential reference already exists.',
  poolKeyStoredPending: 'The key was added, but the credential could not be stored. Retry to store it.',
  poolKeyCredentialPending: 'Credential not stored',
  poolProbeFailed: 'The key probe failed.',
  poolHealthy: 'Healthy',
  poolOpen: 'Open',
  poolTrial: 'In use',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  poolPriority: '优先级',
  poolWeighted: '权重',
  poolMaxAttempts: '最大尝试次数',
  poolFailureThreshold: '失败阈值',
  poolOpenCircuitMs: '熔断时间（毫秒）',
  poolSavePolicy: '保存密钥策略',
  poolPrimaryEnabled: '使用主密钥',
  poolEnabled: '启用',
  poolProbe: '测试密钥',
  poolRemove: '删除密钥',
  poolKeyId: '密钥 ID',
  poolCredentialRef: '凭据引用',
  poolApiKey: 'API 密钥',
  poolPriorityField: '优先级',
  poolWeight: '权重',
  poolAddKey: '添加密钥',
  poolKeyIdInvalid: '请使用以小写字母开头的小写 ID。',
  poolCredentialRefInvalid: '请输入有效的环境变量格式凭据引用。',
  poolKeyRequired: '请输入备用 API 密钥。',
  poolKeyIdDuplicate: '密钥 ID 已存在。',
  poolCredentialRefDuplicate: '凭据引用已存在。',
  poolKeyStoredPending: '密钥已加入，但凭据尚未保存成功。点击“重试”继续保存。',
  poolKeyCredentialPending: '凭据未保存',
  poolProbeFailed: '密钥测试失败。',
  poolHealthy: '正常',
  poolOpen: '已熔断',
  poolTrial: '使用中',
