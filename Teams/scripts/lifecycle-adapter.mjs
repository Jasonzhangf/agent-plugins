...
function main() {
  ...
  run('pnpm', ['--dir', projectRoot + '/deepseek-harness', 'exec', 'tsdown', projectRoot + '/Teams/opencode-adapter/src/index.ts', '--out-dir', projectRoot + '/Teams/opencode-adapter/lib', '--format', 'esm', '--platform', 'node', '--target', 'es2022', '--dts', '--clean'], projectRoot)
