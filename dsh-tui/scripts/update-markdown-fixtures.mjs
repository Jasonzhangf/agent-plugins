...
const input = JSON.parse(readFileSync(resolve(root, 'contracts/tui/fixtures/markdown/inputs.json'), 'utf8'));
...
writeFileSync(resolve(root, 'contracts/tui/fixtures/markdown/semantic-tokens.json'), `${JSON.stringify({ schema_version: 1, status: 'admitted', fixtures }, null, 2)}\n`);
