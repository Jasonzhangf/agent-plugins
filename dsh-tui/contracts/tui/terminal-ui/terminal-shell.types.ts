...
export interface TuiTerminalOverlayState {
  readonly view: 'fatal' | 'approval-question' | 'selector.resume-current-cwd' | 'command' | 'queue' | 'overlay.help' | 'interaction.approval' | 'interaction.question' | 'selector.model' | 'selector.provider' | 'selector.permission' | 'selector.fork-history' | 'selector.workspaces' | 'selector.subagents'
