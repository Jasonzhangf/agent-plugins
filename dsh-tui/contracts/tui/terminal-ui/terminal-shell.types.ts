...
export interface TuiTerminalOverlayState {
  readonly view: 'fatal' | 'approval-question' | 'selector.resume-current-cwd' | 'command' | 'queue' | 'overlay.jobs' | 'overlay.help' | 'interaction.approval' | 'interaction.question' | 'selector.model' | 'selector.provider' | 'selector.permission' | 'selector.fork-history' | 'selector.workspaces' | 'selector.subagents' | 'selector.session-search'
