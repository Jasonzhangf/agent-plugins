...
const expectedTargetForbiddenRelations = new Set([
  ...
  'tui_session_selection_control->official_api_contract',
  'tui_slash_command_control->official_api_contract',
  'tui_slash_command_control->current_session_selection',
  'tui_session_selection_control->terminal_lifecycle',
